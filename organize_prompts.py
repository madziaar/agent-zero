...
-------------------------------------
This script analyzes the prompts directory and suggests a better organization structure.
...
def main():
    ...
    print("This tool analyzes and reorganizes the prompt files for better organization.\n")
    ...
    choice = input("\nWould you like to implement this reorganization? (y/n): ")
    ...
    if choice.lower() == 'y':
        ...
        print("\nNo changes were made. You can run this script again later to implement the changes.")
